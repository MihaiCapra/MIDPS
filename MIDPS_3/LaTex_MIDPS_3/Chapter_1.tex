...
\end{center}
Cind selectam un buton in modul grafic putem modifica(caption,color,font,style,name...) din Diolog-Boxul din dreapta numit Properties.\\
\begin{center}
...
\end{center}
\begin{flushleft}
\lstinputlisting{source/button_click.cs}
\end{flushleft}
...
\begin{flushleft}
\lstinputlisting[firstline=15,lastline=18]{source/Form1.cs}
\lstinputlisting[firstline=40,lastline=44]{source/Form1.cs}
\lstinputlisting[firstline=106,lastline=112]{source/Form1.cs}
\end{flushleft}
